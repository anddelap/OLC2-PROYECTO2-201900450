...
class Vector(Expression):
    ...
    def execute(self, environment: Environment) -> Symbol:
        if(self.exp != None and self.cantidad != None and self.listExp==None):
            ...
            if(cant.getType() == typeExpression.INTEGER):
                ...
                tempSymbol: Symbol = Symbol('',tempExp,typeExpression.VECTOR,self.fila,self.columna)
                tempSymbol.array = True
                return tempSymbol
            else:
                archivo = open("Salida.txt", "a")
                archivo.write("Error: la cantidaddebe de ser Integer\n")
                archivo.close()
                ...
                tempSymbol.array = True
                return tempSymbol
        elif(self.listExp==None and self.exp == None and self.cantidad == None):
            tempExp = []
            tempSymbol: Symbol = Symbol('',tempExp,typeExpression.VECTOR,self.fila,self.columna)
            tempSymbol.array = True
            return tempSymbol
            ...
            tempSymbol: Symbol = Symbol('',tempExp,typeExpression.VECTOR,self.fila,self.columna)
            tempSymbol.array = True
            tempSymbol.VectorCapacity = self.cantidad
            return tempSymbol
        elif(self.listExp!=None and self.exp == None and self.cantidad == None):
            tempExp = []
